...
import AiLoader from "../assets/chatIcons/AiLoading.gif";
import AiLoaderNoAnimation from "../assets/chatIcons/AiLoadingNotAnimation.png";
        ...
        <div className="buttons-container">
          ...
          >
            <div className="btn-icon">
              <img
                src={loading ? AiLoader : AiLoaderNoAnimation}
                alt="loader-img"
              />
            </div>
